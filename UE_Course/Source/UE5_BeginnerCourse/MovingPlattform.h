...
protected:
	...
	FORCEINLINE
		virtual bool GetConditionsMet() { return bConditonMet; }

	FORCEINLINE
		virtual void SetConditionsMet(bool status) {bConditonMet = status; }
	FORCEINLINE
		virtual bool Conditional_Start_End() { return bConditional_Start_End; }
	FORCEINLINE
		virtual bool Conditional_Start_Start() { return bConditional_Start_Start; }
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Infos, meta = (AllowPrivateAccess))
	UCurveFloat* curveFloat1;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Infos, meta = (AllowPrivateAccess))
		bool bConditional_Start_End;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Infos, meta = (AllowPrivateAccess))
		bool bConditional_Start_Start;
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Infos, meta = (AllowPrivateAccess))
		bool bConditonMet;
